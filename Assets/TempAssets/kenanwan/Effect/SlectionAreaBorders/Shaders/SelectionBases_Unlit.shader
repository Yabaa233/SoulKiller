Shader "MS_Shader/UnlitSelectionBases"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				#endif
                fixed4 col = tex2D(_MainTex, i.uv1-fixed2(_ScaleSpeedMainTex.z,_ScaleSpeedMainTex.a)*_Time)
            	*tex2D(_MainNoiseTex, i.uv2-fixed2(_ScaleSpeedMainNoiseTex.z,_ScaleSpeedMainNoiseTex.a)*_Time)
            	*i.color*_TintColor;
