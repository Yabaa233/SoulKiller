...
public class RotateJoyStick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        GameManager.Instance.currentPlayer.GetPlayerInput_StickRotate(newPos);
    }
